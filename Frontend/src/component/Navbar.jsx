...
function Navbar() {
  ...
  // try this logic const [theme, setTheme] = useState(localStorage.getItem("theme")||"light");
  ...
  const line = location.pathname;

  const navItems = (
    <>
      <li onClick={() => setLine("Home")}>
        <Link to="/">Home</Link>
        {line === "/" ? <ActiveHeader /> : <></>}
      </li>
      <li onClick={() => setLine("Course")}>
        <Link to="/courses">Course</Link>
        {line === "/courses" ? <ActiveHeader /> : <></>}
      </li>
      <li onClick={() => setLine("Contact")}>
        <Link to="/contact">Contact</Link>
        {line === "/contact" ? <ActiveHeader /> : <></>}
      </li>
      <li onClick={() => setLine("About")}>
        <Link to="/about">About</Link>
        {line === "/about" ? <ActiveHeader /> : <></>}
      </li>
    </>
  );
      ...
      >
        <div className="navbar">
          <div className="navbar-start">
            ...
            >
              <span className="text-pink-500 text-xl md:text-3xl">L</span>
              earn <span className="text-pink-500 text-xl md:text-3xl">C</span>
              oding
            </Link>
          </div>
...
const ActiveHeader = () => (
  <hr className="border-none bg-pink-400 w-full h-[4px] rounded-full duration-1000" />
);
